...
func (usr *userservice) Register(user model.User) (http.Response, error) {
...
func (usr *userservice) Login(user model.User) (http.Response, error) {
	json_data, _ := json.Marshal(&user)
...
func (usr *userservice) Detail(id *int) (http.Response, error) {
